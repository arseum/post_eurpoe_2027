...
const ENEMY_TYPES = [
  ...
  { id: 'eclaireur',  name: 'Éclaireur',  icon: '🏃', hp: 14, atk: 9,  def: 2,  spd: 7, frontline: false, cost: 3,  minWave: 6  },
  { id: 'blinde',     name: 'Blindé',     icon: '🛡️', hp: 45, atk: 8,  def: 8,  spd: 2, frontline: true,  cost: 5,  minWave: 11 },
  { id: 'commandant', name: 'Commandant', icon: '⭐', hp: 38, atk: 13, def: 6,  spd: 5, frontline: true,  cost: 7,  minWave: 16 },
  { id: 'destroyer',  name: 'Destroyer',  icon: '💀', hp: 70, atk: 20, def: 12, spd: 3, frontline: true,  cost: 10, minWave: 21 }
];
...
const CHAPTERS = [
  { num: 1, name: 'SURVIE',          sub: 'Établir les fondations',  desc: "Le dôme se réactive. Construisez vos défenses et repoussez les premiers raiders." },
  { num: 2, name: 'EXPANSION',       sub: 'Diplomatie et alliances',  desc: "D'autres cités émergent. Forgez des alliances et développez votre technologie." },
  { num: 3, name: 'CONFRONTATION',   sub: 'Le destin de l\'Europe',   desc: "Hegemonia approche. Préparez-vous pour l'assaut final." }
];
...
const EVENTS = [
  ...
  },
  {
    ...
    choices: [
      { text: 'Réparer (-5🔩)',       effect: '🔩-5, conduite réparée', effects: { materials: -5 }, flags: { conduitReparee: true } },
  ...
  },
  {
    ...
    choices: [
      { text: 'Les accueillir',           effect: '⚡-3 🔩-3 🏛️+8 🌐+3', effects: { energy: -3, materials: -3, stability: 8, influence: 3 }, flags: { refugiesAccueillis: true } },
      { text: 'Les refouler',             effect: '🏛️-5 🔩+3',           effects: { stability: -5, materials: 3 },                           flags: {} },
      { text: 'Accepter sous conditions', effect: '⚡-2 🏛️+4 🌐+1',      effects: { energy: -2, stability: 4, influence: 1 },                flags: {} }
    ]
  },
  {
    ...
    choices: [
      { text: 'Envoyer une expédition', effect: '⚡-5 🔩-3 💾+12', effects: { energy: -5, materials: -3, data: 12 }, flags: { cernContacte: true } },
  ...
  },
  {
    ...
    choices: [
      { text: 'Laisser évoluer',     effect: '💾+5 🏛️-3', effects: { data: 5, stability: -3 }, flags: { iaEvolution: true } },
      { text: "Restreindre l'IA",    effect: '💾-3 🏛️+3', effects: { data: -3, stability: 3 }, flags: { iaRestreinte: true } },
  ...
  },
  {
    ...
    choices: [
      { text: 'Renforcer les filtres',   effect: '🔩-8 ⚡-3 🏛️+5', effects: { materials: -8, energy: -3, stability: 5 }, flags: {} },
  ...
  },
  {
    ...
    choices: [
      { text: 'Proposer un sommet',  effect: '⚡-5 🌐+5',  effects: { energy: -5, influence: 5 },   flags: { sommetPropose: true } },
  ...
  },
  {
    ...
    choices: [
      { text: "Accepter l'alliance", effect: '🔩-5 🌐+5 💾+5', effects: { materials: -5, influence: 5, data: 5 }, flags: { allianceLyon: true } },
      { text: 'Négocier mieux',      effect: '💾-3 🌐+4',       effects: { data: -3, influence: 4 },             flags: { allianceLyon: true }, requires: s => s.resources.influence >= 8 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Renforcer la sécurité', effect: '🔩-5 ⚡-3 🏛️+3', effects: { materials: -5, energy: -3, stability: 3 }, flags: {} },
  ...
  },
  {
    ...
    choices: [
      { text: 'Explorer',           effect: '⚡-5 🔩+10 💾+8', effects: { energy: -5, materials: 10, data: 8 }, flags: { complexeExplore: true } },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Mobiliser les biotechs', effect: '💾-8 ⚡-5 🏛️+5', effects: { data: -8, energy: -5, stability: 5 }, flags: {}, requires: s => s.buildings.includes('labo') },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Préparer les défenses', effect: '🔩-5 ⚡-5 🏛️+3', effects: { materials: -5, energy: -5, stability: 3 }, flags: { defensesPretes: true } },
  ...
  },
  {
    ...
    choices: [
      { text: 'Défier ouvertement',      effect: '🏛️+5 🌐+5 ⚡-5', effects: { stability: 5, influence: 5, energy: -5 }, flags: {} },
      { text: 'Négocier du temps',       effect: '🌐+3',            effects: { influence: 3 },                          flags: {}, requires: s => s.flags.hegemoniaContact },
      { text: 'Envisager la capitulation', effect: '🏛️-10',        effects: { stability: -10 },                         flags: { capitulationEnvisagee: true } }
    ]
  },
  {
    ...
    choices: [
      ...
      { text: 'Intégrer les dissidents', effect: '💾-3 🏛️+8',     effects: { data: -3, stability: 8 },                flags: { dissidentsIntegres: true }, requires: s => s.resources.stability >= 40 }
    ]
  },
  {
    ...
    choices: [
      ...
      { text: 'Fusionner les réseaux', effect: '💾+8 🌐+3',   effects: { data: 8, influence: 3 },    flags: { iaFusion: true }, requires: s => s.flags.iaDialogue || s.flags.iaEvolution }
    ]
  },
  {
